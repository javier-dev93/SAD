...
Además de este resumen paramétrico, para conocer con más detenimiento algunas de las variables del conjunto de datos podemos realizar diversas representaciones gráficas.
...
Para evaluar de un vistazo los datos de las variables categóricas podemos representarlas todas a la vez utilizando un barplot agrupado:

```{r}
variables_categoricas <- cervical_cancer[,columnas_booleanas]

variables_categoricas2 <- apply(variables_categoricas,2,table)
```
