...
Una vez tratados los datos, procederemos a aplicar distintas técnicas de clustering para lo que realizaremos el análisis de dos métodos.
...
Conforme aumentamos el número de ejemplos a tratar, la mayoría de los ejemplos se clasifican en el cluster 1, mientras que una minoría de ejemplos se clasifican en el cluster 2.
