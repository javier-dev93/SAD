...
# Comprobamos que hemos elminado los missing values 
cervical_cancer[is.na(cervical_cancer)]
```
...
100*sum(cervical_cancer$Dx.Cancer=="1")/nrow(cervical_cancer)
```
...
nrow(cervical_cancer[(cervical_cancer$Dx.Cancer=="1" & cervical_cancer$Dx.HPV=="1"),])
...
nrow(cervical_cancer[(cervical_cancer$Dx.Cancer=="1" & cervical_cancer$Dx.HPV=="1"),])*100 / nrow(cervical_cancer[(cervical_cancer$Dx.Cancer=="1"),])
```
...
# Recodificamos la variable smoke para que sea más explicativa
cervical_data_anova$STDs <- factor(cervical_data_anova$STDs, levels=c(0,1),labels=c("No","Yes"))
